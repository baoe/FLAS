...
########################################
	bronkerbosch2_command = 'python ./src/bronkerbosch.py ' + temp_dir + '/step2/' + 'allreads0_corrected_filted1.fasta.m4 ' + temp_dir + '/step2/' + 'clique2.txt ' +  temp_dir + '/step2/' + 'edge2.txt '
